...
export default function DanhRiengChoBan() {
    ...
    async function LayTatCaSanPham(page) {
        let res = await axios.get('hethong/products-all-showpage/' + page);
    ...
    return (
        <Fragment>
            <img style={{ marginTop: '50px' }} src='https://ingiaphat.com.vn/wp-content/uploads/2020/02/banner1.jpg' height='300' width='100%'></img>
